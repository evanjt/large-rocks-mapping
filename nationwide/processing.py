...
def generate_hillshade(dsm_path: str | Path) -> np.ndarray:
    """Generate hillshade via gdaldem -igor (overhead diffuse illumination).

    Igor's formula produces cos(slope) shading that is direction-agnostic.
    This matches the training data generated by generate_hillshade.py --igor.
    """
